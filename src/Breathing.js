...
//   Below is the message I wanted people to see when they look on my home page, to explain why I have created this site. 
    render() {
        ...
        return (
            <div>
                "Breath is what fuels our lives, it is the only thing that will be with us every moment of our lives." 
             
                "First thing that you need to do is inhale for five seconds, hold for five seconds, and exhale for five seconds."
            </div>
        )
